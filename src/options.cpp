...
const option::Descriptor usage[] =
{
    ...
    { SET_TAG, 0, "s", "set-tag", option::Arg::Optional, "{-s, --set-tag=}NAME=...\n          Set tag. Old value will be overwritten" },
    ...
    { REMOVE_TAGS, 0, "r", "remove-tags", option::Arg::Optional, "{-r, --remove-tags=}a,b,c\n          Remove ALL occurences of the specified tags" },
    ...
    { IMPORT_PICTURE, 0, "p", "import-picture", option::Arg::Optional, "{-p, --import-picture=}file[|type|comment]\n          Import picture into file."},
